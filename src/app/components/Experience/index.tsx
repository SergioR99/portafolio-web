                        ...
                        <ul className="sm:flex sm:flex-wrap sm:items-center md:flex-col sm:w-full md:w-1/3 md:space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
                            <li>
                                <a 
                                    ...
                                    className={`inline-flex items-center px-4 py-3 hover:text-gray-900 hover:cursor-pointer hover:bg-cyan-500 rounded-lg ${activeTab === 'este' ? 'bg-cyan-600 text-white' : 'bg-white'} w-full dark:bg-cyan-600`}>
                        ...
                        <div className="w-full">
                            {activeTab === 'este' && (
                                <div className="p-6 bg-white text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full">
                                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Este Ingeniería</h3>
