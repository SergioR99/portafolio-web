...
export default function AboutSection( {title, subtitle, parrafo, parrafo2}: Props) {

    return (
        <div className="bg-neutral-100 flex items-center" style={{minHeight: "85vh"}}>
            <div className="mx-auto max-w-7xl px-8 flex-col md:flex-row lg:px-48 flex justify-between items-center md:py-4 sm:py-8">
                <div className='text-left flex-initial w-full md:w-2/3'>
                    ...
                    <p className={`${roboto.variable} antialiased text-base text-cyan-950`}>{parrafo}</p>
                    <p className={`${roboto.variable} antialiased text-base text-cyan-950 mt-2`}>{parrafo2}</p>
                </div>
                <div>
                    <Image
